...
import { mensajeWhatsApp, useCarrito } from "@/components/carrito";
...
export function CarritoDrawer() {
  const { items, total, abierto, cerrar, quitar, cambiarCantidad, vaciar } = useCarrito();
        ...
        {items.length > 0 && (
          <div className="border-t border-border bg-cream px-5 py-4">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              🚚 Envío gratis en Medellín y Área Metropolitana · Resto del país por transportadora
            </p>
            <a
            ...
            <p className="mt-2 text-center text-[11px] text-muted-foreground">
              Te enviamos el resumen del pedido al chat y ahí confirmamos talla y pago.
            </p>
          </div>
        )}
      </aside>
